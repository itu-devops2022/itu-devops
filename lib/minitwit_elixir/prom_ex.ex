defmodule MinitwitElixir.PromEx do
  @moduledoc """
  ...
  use PromEx, otp_app: :minitwit_elixir
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: MinitwitElixirWeb.Router, endpoint: MinitwitElixirWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboard_assigns do
    [
      datasource_id: "MINITWIT_ELIXIR_PROMETHEUS",
